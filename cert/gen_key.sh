...
clientSubject="/C=$country/ST=$state/L=$locality/O=$organization/OU=$organizationalunit/CN=*.client/emailAddress=$email"
...
openssl req -newkey rsa:4096 -nodes -keyout client-key.pem -out client-req.pem -subj "$clientSubject"
